...
ranges::Range<TransportCatalogue::StopDistancesMap::const_iterator> TransportCatalogue::GetStopsDistanceRange() const {
    return ranges::AsRange(stops_to_distance_);
}
} // namespace transport_catalogue
